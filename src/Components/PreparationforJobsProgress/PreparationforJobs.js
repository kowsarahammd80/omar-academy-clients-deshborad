...
const PreparationforJobs = () => {
  ...
  return (
    ...
    <div>
         <div className="card w-100 bg-base-100 shadow-xl mx-5 lg:mx-0 bg-background-job">
        <div className="card-body ">
          <div className="flex justify-center">
            <div
              className="radial-progress progress-set-job font-bold"
              style={{
                "--value": "70",
                "--size": "12rem",
                "--thickness": "10px",
