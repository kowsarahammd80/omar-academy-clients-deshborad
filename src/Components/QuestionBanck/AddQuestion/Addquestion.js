...
function Addquestion() {
  ...
  const handlebook = async event => {
    ...
    formData.append("ownerimg", user?.photURL);
  ...
  return (
    <div>
      ...
      <div className="text-center mt-10">
        <h1 className="text-2xl lg:text-4xl font-semibold">Question post</h1>
      </div>
      {/* post input */}
      <div className="mx-5">
                ...
                <div className="mt-3 mb-2 grid grid-cols-1 lg:grid-cols-2 gap-3">
                  ...
                  <div>
                    <p className="font-semibold pb-2 capitalize text-md">
                      {" "}
                      <label htmlFor="selectOption">Question Type</label>
                    </p>
                    <select
                      required
                  ...
                  {questiontype === "Academic" && (
                    <div>
                      <p className="font-semibold pb-2 capitalize text-md">
                        {" "}
                        <label htmlFor="selectOption">class</label>
                      </p>
                      <select
                        required
                        className="p-3 select select-bordered w-full max-w-xs"
